...
class ArticleCommentManagementServiceTest {
    ...
    class RealApiTest {
        ...
        @Autowired
        public RealApiTest(ArticleCommentManagementService articleCommentManagementService) {
            this.sut = articleCommentManagementService;
        }
        ...
        void given_when_then() {
            ...
            // Then
            System.out.println(comments.stream().findFirst());
    ...
    class RestTemplateTest {
        ...
        @Test
        void givenNothing_whenCallCommentsApi_thenReturnCommentList() throws JsonProcessingException {
            // Given
        ...
        @DisplayName("댓글 ID와 함께 댓글 API를 호출하면, 해당 댓글을 가져온다.")
        @Test
        void givenCommentId_whenCallCommentApi_thenReturnsComment() throws JsonProcessingException {
            // Given
        ...
        @Test
        void givenCommentId_whenCallingDeleteCommentApi_thenDeleteComment() {
            // Given
            Long articleCommentId = 1L;
            server
                    .expect(requestTo(projectProperties.board().url() + "/api/articleComments/" + articleCommentId))
