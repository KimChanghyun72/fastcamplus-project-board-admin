...
class UserAccountManagementServiceTest {
    ...
    class RealApiTest {
        ...
        @Autowired
        public RealApiTest(UserAccountManagementService userAccountManagementService) {
            this.sut = userAccountManagementService;
        }
        @DisplayName("회원 API를 호출하면 회원 목록을 가져온다.")
        @Test
        void givenNothing_whenRequestAllEntities_thenReturns() {
            // Given

            // When
            List<UserAccountDto> results = sut.getUserAccountes();
    ...
    class RestTemplateTest {
        ...
        @Autowired
        public RestTemplateTest(UserAccountManagementService userAccountManagementService,
        ...
        @Test
        void givenNothing_whenRequestGetAllApi_thenReturnsAsList() throws JsonProcessingException {
            // Given
            ...
            // When
            List<UserAccountDto> result = sut.getUserAccountes();
        ...
        @Test
        void givenId_whenRequestGetOneApi_thenReturn() throws JsonProcessingException {
            // Given
            String userId = "uno";
